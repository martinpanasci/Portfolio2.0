    ...
    <div id="home" className="py-32 relative z-0  overflow-x-clip">
      ...
      <div className="container">
        ...
        <div className="max-w-xl mx-auto">
          <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Martin Panasci<br /><span className="bg-gradient-to-r from-emerald-300 to-sky-400 text-center bg-clip-text text-transparent">Full Stack</span> Developer</h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">
            Specialized in backend development and scalable solutions. Turning ideas into efficient software with performance, security, and maintainability in mind.
          </p>
        </div>
