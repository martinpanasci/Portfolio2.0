      ...
      <div className="w-full flex flex-col justify-center items-center fixed top-3 z-50">
        <nav className="flex gap-1 p-0.5 border border-white/15 rounded-full bg-white/10 backdrop-blur">
          ...
          <Link
            ...
            smooth
            duration={500}
            className="nav-item cursor-pointer hidden md:flex"
          >
            {t("Header.experience")}
          </Link>
          <Link
            ...
            smooth
            duration={500}
            className="nav-item cursor-pointer bg-white text-gray-900 hover:bg-white/70 hover:text-gray-900"
          >
            {t("Header.contact")}
          </Link>
        </nav>
        ...
        <nav className="flex p-0.5 border border-white/15 border-t-0 rounded-full bg-white/10 backdrop-blur -mt-[0px]">
          <a
            href="https://mpanasci.com/cv.pdf"
            target="_blank"
