    ...
    <footer className="relative overflow-x-clip">
      ...
      <div className="container">
        <div className="border-t border-white/15 py-6 text-sm flex flex-col md:flex-row md:justify-between items-center gap-8">
          <div className="text-white/40">&copy; 2025. MPanasci All rights reserved.</div>
          ...
          <nav className="flex flex-col md:flex-row items-center gap-8 pointer-events-auto">
            ...
            <div className="relative inline-flex items-center gap-1.5">
              ...
              {copiedEmail && <span className="tooltip-bottom tooltip-visible">Email copied!</span>}
              <ArrowUpRightIcon className="size-4" />
            </div>
            <div className="relative inline-flex items-center gap-1.5">
              <button 
              ...
              {copiedPhone && <span className="tooltip-bottom tooltip-visible">Phone copied!</span>}
              <ArrowUpRightIcon className="size-4" />
            </div>
